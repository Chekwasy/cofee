...
const slides = [
  {
    ...
    subtitle: "Special flavours just for you",
    image: require("@/assets/images/cofee.jpg"),
  },
  {
    id: "2",
    title: "Update your prefrences",
    subtitle: "Favorite combo",
    image: require("@/assets/images/coffee-beans.jpg"),
  },
  {
    id: "3",
    title: "Explore new flavours",
    subtitle: "Relax and let us bring the coffee to you",
  ...
  return (
    <SafeAreaView className="flex-1 w-full h-full mt-8 bg-primary-light">
      ...
      <View className="bg-primary-onboardGrayDark h-[42%] w-full -mt-24 items-center justify-center pt-8 pb-12 z-0">
        ...
        {/* Button */}
        <OnboardButton title="Buy a Coffee Now" onPress={handleNext} />
      </View>
    </SafeAreaView>
  );
}
